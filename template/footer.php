             ...
             <div class="container">
              <div class="row">
                  <div class="col-lg-3 col-sm-3">
                       <a href="#"><img class="img-circle img-thumbnail img-responsive" src="./img/logo.png" width="150" height="150" alt=""></a>
                  </div>
                <div class="col-lg-3 col-sm-3">
                    <p> <a href="http://zao-rim.ru/">АО "РИМ"</a> &nbsp;©&nbsp;2017</p>
                    <p>Novosibirsk</p>
                    <p>+7(800) 555-35-35</p>
                    <p>zao-rim.ru</p>
